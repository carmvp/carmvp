...
$(function () {
    ...
    $("#jiepai_sub li").hover(function () {
        ...
        $("#jiepai_slider1,#jiepai_slider2,#jiepai_slider3,#jiepai_slider4,#jiepai_slider5,#jiepai_slider6,#jiepai_slider7,#jiepai_slider8").hide();
        $("#jiepai_slider" + data).show();
        jiepai_pointer = 0;
        $("#jiepai_scroll_img .scroll_left a").hide();
        $("#jiepai_scroll_img .scroll_right a").show();
        $("#jiepai_slider1,#jiepai_slider2,#jiepai_slider3,#jiepai_slider4,#jiepai_slider5,#jiepai_slider6,#jiepai_slider7,#jiepai_slider8").find("ul").css("margin-left", 0);
