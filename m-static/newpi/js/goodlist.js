...
(function($){
    ...
    $(".goods-list .buy-over a").live('click', function(e){
    ...
    //卷皮列表页提醒
    $(".goods-list li .good-pic,.goods-list li .good-title,.goods-list li .good-price,.goods-list .mask-bg,.goods-list .buy-over,.goods-list .gone").live('click', function(){
       ...
       if($(this).parents("li").find(".gift").hasClass("gone")){
        ...
        if($(this).parents("li").find(".list-good").hasClass("gone")){
            ...
            if($(this).parents("li").find(".like-ico").hasClass("l-active")){
                ...
                var content = '<div class="top_tips"><p><em class="over">商品抢光了！点击收藏随时关注</em></p><p class="tips01">因商品已经抢光，无法跳转到淘宝下单</p></div><div class="item-btn clear"><div class="collect-box  fl"><a class="y-like item-like" data-pid="'+gid+'" href="javascript:;"><em class="heart"></em><p class="like-l">收藏</p></a><p class="like-o"><span class="fl">下载APP购物更省钱</span><a href="/help/app" target="_blank" class="phone fr"></a></p></div></div>';
            }
        }else{
            if($(this).parents("li").find(".like-ico").hasClass("l-active")){
                var content = '<div class="top_tips"><p><em class="over">商品还未开始，请关注您的收藏夹！</em></p></div><div class="item-btn clear"><div class="collect-box  fl"><a data-gtype="'+gtype+'" data-gid="'+gid+'" class="y-like item-like active" href="javascript:void(0)"><em class="heart"></em><p class="like-l">已收藏</p></a><p class="like-o"><span class="fl">下载APP购物更省钱</span><a href="/help/app" target="_blank" class="phone fr"></a></p></div></div>';
            }else{
                var content = '<div class="top_tips"><p><em class="over">商品还未开始，点击收藏随时关注！</em></p></div><div class="item-btn clear"><div class="collect-box  fl"><a class="y-like item-like" data-pid="'+gid+'" href="javascript:;"><em class="heart"></em><p class="like-l">收藏</p></a><p class="like-o"><span class="fl">下载APP购物更省钱</span><a href="/help/app" target="_blank" class="phone fr"></a></p></div></div>';
            }
        }
...
(function($){
    ...
    $(".zc-list .buy-over a").live('click', function(e){
        if (e && e.stopPropagation) {
            e.stopPropagation();
        }else {//IE浏览器
            window.event.cancelBubble = true;
