...
fetch('//api.uomg.com/api/rand.qinghua')
    .then(function (res){
      return res.json();
    })
    .then(function (data) {
      var text = document.getElementById('qh');
      text.innerText = data.content;
 })
 
 fetch('//api.uomg.com/api/rand.avatar?sort=%E5%8A%A8%E6%BC%AB%E5%A5%B3&format=json')
    .then(function (res){
      return res.json();
    })
    .then(function (data) {
      var text = document.getElementById('img1');
      text.src = data.imgurl;
 })
