!function() {
    ...
    i = function(e) {
        var o = {
			...
			//show: $("#anchors_show").offset().top - 45,
            //ant: $("#anchors_ant").offset().top - 45
        },
        t = $(document).scrollTop();
        t >= o.info && ($(".header_goods .icon_header>div.title a").removeClass("active"), $(".header_goods .icon_header>div.title a[anchors='anchors_info']").addClass("active"))
    };
