!function() {
    ...
    $(document).scroll(function(e) {
        ...
        a >= $("#goods_item_list").offset().top - $(window).height() && !$("#goods_item_list").attr("upload") && o()
    }),
    ...
    var o = function() {
        ...
        var e = $("#goods_item_list").data("item");
        $("#goods_item_list .goods-new").html($cmsApi.goodsListTplpdd(e, $("#goods_item_list").data("open"))),
        wui.init("directive")        
    },
    t = function() {},
    i = function(e) {
        ...
        t >= o.info && t < o.title ? ($(".header_goods .icon_header>div.title a").removeClass("active"), $(".header_goods .icon_header>div.title a[anchors='anchors_info']").addClass("active")) : t >= o.title && t < o.ant ? ($(".header_goods .icon_header>div.title a").removeClass("active"), $(".header_goods .icon_header>div.title a[anchors='anchors_title']").addClass("active")) : t >= o.ant && ($(".header_goods .icon_header>div.title a").removeClass("active"), $(".header_goods .icon_header>div.title a[anchors='anchors_ant']").addClass("active"))
    };
