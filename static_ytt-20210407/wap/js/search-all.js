!function(t) {
            ...
            case 1:
                ...
                function(t, n) {
                    ...
                    function() {
                        ...
                        t
                    } () ? "": '<div class="goods-item clearfix" data-id="' + this.id + "_" + this.jiage + '"><a data-transition="slide" href="' + a.getItemUrl(this) + '" class="img ui-link" style="min-height:' + s + 'px"><img src="' + this.pic + '_310x310.jpg"></a><div class="text"> <div><a data-transition="slide" href="' + a.getItemUrl(this) + '" class="title ui-link">' + this.d_title + '</a><span class="coupon-wrapper  theme-bg-color-1">券 <i>￥</i><b>' + this.quan_jine + '</b></span><div class="price-wrapper"><span class="price">￥<span>' + this.jiage + '</span></span><span class="price_yj">券后</span><div class="sold-wrapper"><span class="text">销量 </span><span class="sold-num">' + a.getNumberText(this.xiaoliang) + "</span></div></div></div></div></div>",
                    i = this.id
                })
            }
        } () : void 0,
    ...
    a.prototype.getItemUrl = function(t) {
        var i = function(t) {
            var i;
            switch (t) {
            case "dtk":
        ...
        return this.goodsUrl + "&id=" + t.id + "&type=" + i(t.from)
    },
    t.$sort = a
} (window);